    ...
    <main className="flex min-h-screen w-full items-center justify-center bg-[#0A1A2F] px-5 py-8 text-[#D9E1E8] sm:px-6">
      <section className="w-full max-w-[420px]">
        ...
        <form onSubmit={handleSignIn} className="space-y-5">
          <div>
            <label htmlFor="login-id" className="mb-2 block text-sm font-medium text-[#D9E1E8]">
              Email or Username
            </label>
            <input
              id="login-id"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="h-12 w-full rounded-md border border-white/10 bg-white/[0.08] px-4 pr-12 text-sm text-white outline-none transition placeholder:text-[#D9E1E8]/45 focus:border-[#3EC6FF]/70 focus:ring-2 focus:ring-[#3EC6FF]/20"
                disabled={loading}
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex w-12 items-center justify-center text-[#D9E1E8]/55 transition hover:text-[#D9E1E8] disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            <div className="mt-3 flex items-center justify-between gap-4">
              <label
                htmlFor="remember-me"
                className="inline-flex cursor-pointer items-center gap-2 text-xs font-semibold text-[#D9E1E8]/80 transition hover:text-white"
              >
                <input
                  id="remember-me"
                  type="checkbox"
                  ...
                  disabled={loading}
                  className="h-3.5 w-3.5 rounded border-white/20 bg-white/10 text-[#3EC6FF] accent-[#3EC6FF]"
                />
