  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#07111f] px-4 py-8 text-slate-100 sm:px-6">
      ...
      <section className="relative w-full max-w-md rounded-[2rem] border border-white/10 bg-slate-950/82 p-6 shadow-[0_28px_90px_rgba(0,0,0,0.45)] backdrop-blur sm:p-8">
        ...
        {(!supabase || error) && (
          <div className="mb-5 rounded-2xl border border-red-400/30 bg-red-950/45 px-4 py-3">
        ...
        {notice && (
          <div className="mb-5 rounded-2xl border border-emerald-400/30 bg-emerald-950/40 px-4 py-3">
            <p className="text-sm leading-6 text-emerald-100">{notice}</p>
          </div>
        )}
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="h-12 w-full rounded-2xl border border-slate-700 bg-slate-900/90 px-4 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-blue-400 focus:ring-4 focus:ring-blue-500/20"
          ...
          <button
            type="submit"
            disabled={loading || !supabase}
            className="flex h-12 w-full items-center justify-center rounded-2xl bg-blue-500 px-4 text-sm font-bold text-white shadow-lg shadow-blue-950/40 transition hover:bg-blue-400 disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-400"
          >
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading || !supabase}
            className="flex h-12 w-full items-center justify-center gap-3 rounded-2xl border border-slate-700 bg-slate-900/60 px-4 text-sm font-semibold text-slate-100 transition hover:border-slate-500 hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
          >
