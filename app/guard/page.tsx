    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-semibold text-slate-900">Guard Workbench</h1>
          <p className="mt-2 text-slate-600 max-w-2xl">Select your assigned pool and submit a daily chemistry log.</p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 mb-8">
          <Link
            href="/guard/log"
            className="rounded-3xl border border-blue-200 bg-white p-6 text-left shadow-sm transition hover:border-blue-300 hover:shadow-md"
          >
          ...
          <Link
            href="/guard/review"
            className="rounded-3xl border border-slate-200 bg-white p-6 text-left shadow-sm transition hover:border-slate-300 hover:shadow-md"
          >
          ...
          <Link
            ...
            className="rounded-3xl border border-slate-200 bg-white p-6 text-left shadow-sm transition hover:border-slate-300 hover:shadow-md"
          >
            <p className="text-sm font-semibold text-slate-700">Manager Tools</p>
            <p className="mt-3 text-slate-700">If you need management access, visit the supervisor dashboard.</p>
          </Link>
        </div>
